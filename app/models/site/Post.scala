...
object Posts extends Table[Post]("post") {
  ...
  def * = id.? ~ uid ~ sid ~ cid ~ title ~ pic.? ~ content ~ tags.? ~ status ~ isTop ~ viewNum ~ loveNum ~ replyNum ~ extraAttr1.? ~ extraAttr2.? ~ extraAttr3.? ~ extraAttr4.? ~ extraAttr5.? ~ extraAttr6.?  ~addTime.? <>(Post, Post.unapply _)
  def autoInc = id.? ~ uid ~ sid ~ cid ~ title ~ pic.? ~ content ~ tags.? ~ status ~ isTop ~ viewNum ~ loveNum ~ replyNum ~ extraAttr1.? ~ extraAttr2.? ~ extraAttr3.? ~ extraAttr4.? ~ extraAttr5.? ~ extraAttr6.?  ~addTime.? <>(Post, Post.unapply _) returning id
