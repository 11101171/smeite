...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/uploadUEditorAdminPic"             //图片上传提交地址
    ...
    //    ,imageManagerUrl:URL + "jsp/imageManager.jsp"       //图片在线管理的处理地址
     ...
     //   ,getMovieUrl:URL+"jsp/getMovie.jsp"                   //视频数据获取地址
        ...
        , toolbars: [["source","undo","redo","unlink","link","|","insertimage","horizontal","bold","italic","underline","removeformat","formatmatch","autotypeset","fontfamily","fontsize","preview"]]
