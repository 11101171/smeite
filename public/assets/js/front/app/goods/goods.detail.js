...
define(function(require, exports){
  ...
  //  var x = $("#J_LikeCount"), t = {};
   // var  w = commentParameter.productId;
    ...
    $(".appraisal .jd-radio").live("click", function () {
        var a = $(this);
 ...
 //   function C(a) {
    ...
    /* 商品评论翻页*/
    $("#goodsComments a.commentPage").live("click",function(){
 ...
 //   }
  /* 获取用户可能喜欢的商品*/
    ...
    if($(".goods-wall")[0]){
        ...
        $.smeite.goods.conf.columns = 4;
        $.smeite.goods.conf.justFlow = false;
        $.smeite.goods.conf.page=5;
        $.smeite.goods.init();
