define(function(require, exports) {
    ...
    var getBaobeiHtml = function (json) {
        ...
        var html = '<div class="baobei clearfix"><div class="baobei-pic">' +
            ...
            '<p>' + baobeiIntro + '</p>' +
            '</div>' +
            '<div class="price">价格：￥<span class="normalPrice">'+baobeiPrice+'</span></div>'+

            '<div class="clearfix mt15">' +
            '<a class="ilike-n" data-prourl="' + baobeiUrl + '" data-proimgsrc="' + baobeiPhoto + '" data-title="' + baobeiName + '" data-type="0" data-id="' + baobeiId + '" href="javascript:;">喜欢</a>' +
